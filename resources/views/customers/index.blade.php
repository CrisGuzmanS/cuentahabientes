            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6 mt-2">
                            ...
                            <input type="text" value="{{$customer->address}}" class="form-control" readonly>
                        </div>
                        <div class="col-12 col-lg-6 mt-2">
                        ...
                        <div class="col-12 col-lg-6 mt-2">
                            ...
                            <input type="text" value="{{$customer->user->email}}" class="form-control" readonly>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-12 col-lg-6 mt-2">
                            ...
                            <input type="text" value="{{$customer->accounts()->first()->account_number}}" class="form-control" readonly>
                        </div>
                        <div class="col-12 col-lg-6 mt-2">
                            <label for="" class="text-uppercase text-muted">Saldo</label>
                            <input type="text" value="${{$customer->accounts()->first()->balance}}" class="form-control" readonly>
                        </div>
                    </div>
                </div>
                <div class="card-footer">
                    <form action="{{route('customers.destroy', ['customer' => $customer->id])}}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button class="btn btn-danger rounded-0">ELIMINAR</button>
                    </form>
                </div>
            </div>
        </div>
